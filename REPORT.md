...
- **Lists and `map()`** - Used to render drivers, constructors, races, teams, and map markers.
- **API / Fetch** - Used to retrieve live standings, constructor data, race-calendar data, Wikipedia thumbnails, and map resources.
- **Memoization with `useMemo`** - Used for filtered drivers, sorted constructors, team options, route points, and summary statistics.
...
1. Current Formula 1 driver standings with points, wins, position, nationality, and team information.
2. Constructor standings with team points, wins, engine, base location, and driver details.
...
5. Interactive circuit selection with circuit details, track maps, and location information.
6. Driver and constructor detail panels with optional external images and metadata.
7. Automatic standings refresh and animated telemetry speed updates.
8. Loading, retry, fallback-image, and API-error states.
9. Responsive layout with keyboard Escape handling for closing selected detail views.
...
**GitHub Repository:** [Enter your GitHub repository URL]
...
- [ ] Project title is provided.
- [ ] Objective is explained.
- [ ] Methodology is explained.
- [ ] Major features are listed.
